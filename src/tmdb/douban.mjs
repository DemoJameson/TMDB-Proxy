...
async function fetchDoubanJson(url, fetcher) {
	const response = await fetcher(createDoubanRequest(url)).catch(() => undefined);
...
export { fetchDoubanCreditsStats, fetchDoubanSeasons, mergeDoubanCredits, normalizeDoubanCreditsPayload, searchDoubanSubject, splitDoubanCharacters };
